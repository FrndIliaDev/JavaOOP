...
class PhoneRow { private String UnitName; private ArrayList PhoneNumber = new ArrayList<>();
...
class PhoneBook { private int _ai = 0; private static final HashMap<Integer, PhoneRow> phoneBook = new HashMap<>(); public ArrayList sortedKeys = new ArrayList<>();
...
class Printer { public static void main(String[] args) { String name1; String name2; int phone1; int phone2;
